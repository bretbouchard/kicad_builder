...
test_skidl_erc_full_lib = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'RP2040', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'RP2040'}), 'ref_prefix':'U', 'fplist':['RP2040:QFN40P700X700X90-57N'], 'footprint':'RP2040:QFN40P700X700X90-57N', 'keywords':'', 'description':'', 'datasheet':'https://datasheets.raspberrypi.org/rp2040/rp2040-datasheet.pdf', 'pins':[
            ...
            Pin(num='57',name='GND',func=pin_types.PWRIN)], 'unit_defs':[] })])